      ...
      try {
        await mailer().sendMail({
          ...
          text: [
            ...
            internal
              ? [
                "※ 공사 내부용 신청 페이지에서 접수된 건입니다. 아직 자리 확보 단계이며, 공문이 도착해야 접수가 끝납니다.",
                "",
                "[신청하신 분께 — 남은 절차]",
                `1. 사내 공문을 작성하면서 제목이나 본문에 접수번호(${code})를 적습니다.`,
                "2. 기존 신청 양식을 붙임으로 첨부합니다.",
                "3. 공문을 발송하면 접수가 끝납니다.",
                "※ 공문에 접수번호가 없으면 어느 신청 건인지 확인되지 않아 처리가 늦어집니다.",
              ].join("\n")

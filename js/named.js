  ...
  root.innerHTML = `
    ...
    <div class="consent-block">
      ...
      <dl class="consent-dl">
        ...
        <div><dt>처리 방법</dt><dd>입력하신 <b>성명·휴대전화 뒷 4자리와 응답 내용은 담당 부서의 이메일로 전달</b>되어 그 메일함에 보관됩니다. 조사 시스템에는 응답 건수·비율 같은 <b>합계 수치</b>와, 같은 분이 두 번 응답하셨는지만 가리기 위한 <b>되돌릴 수 없는 표시값</b>이 남습니다. 이 표시값으로는 성명·연락처를 알아낼 수 없고 응답 내용과도 연결되지 않으며, 개별 응답은 저장되지 않습니다.</dd></div>
        <div><dt>보유·이용 기간</dt><dd>${m.retainNote
          ? esc(m.retainNote)
          : m.retainDays === 0
            ? `성명·연락처와 응답 내용은 <b>기한 없이</b> 보관합니다.`
            : `성명·연락처와 응답 내용은 <b>수집일부터 ${days(m.retainDays)}</b> 보관 후 지체 없이 파기합니다.`}</dd></div>
